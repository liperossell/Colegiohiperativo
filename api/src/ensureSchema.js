...
/** Garante schema, extensões e tabelas do Hiperativo no banco unificado. */
export async function ensureSchema() {
  await query(`CREATE SCHEMA IF NOT EXISTS hiperativo`);
  await query(`SET search_path TO hiperativo`);
